...
$sqlx = "SELECT * FROM bookinfo where course_name = 'Critical_Thinking_Communication'";
...
<body>
    ...
    <section class="sub-header proTuto">
        ...
        <h1 name="x"> Critical Thinking and Communication </h1>
        <p>Course Code: HUM-112</p>
        ...
        <div class="crsRow facRow">
            ...
            <div class="crsCol">
                ...
                <div class="facultyINFO facDesc">
                    ...
                    <p>
                        Professor <br> Ahsanullah University Of Science and Technology
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="crsRow matRow">
            ...
            <div class="crsCol">
                ...
                <div class="crsMat">
                    ...
                    <a class="matEle" href=<?php   echo $outline   ?>>Outline</a>
                </div>
            </div>
            ...
            <div class="crsCol">
                <div class="crsMat">
                    <div class="matEle pdfICO"><i class="fas fa-file-pdf"></i></div>
                    <a class="matEle" href=<?php   echo $book   ?>>Book</a>
                </div>
            </div>
            ...
            <div class="crsCol">
                ...
                <div class="crsMat">
                    <div class="matEle pdfICO"><i class="fas fa-file-image"></i></div>
                    <a class="matEle" href=<?php echo $exam_question ?>>Exam Questions</a>
                </div>
            </div>
            ...
            <div class="crsCol">
                ...
                <div class="crsMat">
                    <div class="matEle pdfICO"><i class="fas fa-file-pdf"></i></div>
                    <a class="matEle" href=<?php echo $materials  ?>>Materials</a>
                </div>
