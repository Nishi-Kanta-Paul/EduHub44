...
<head>
    ...
    <title>Android App Development Tutorials EDUHub44</title>
...
<body>
    ...
    <section class="sub-header androidheader">
    ...
    <section class="contactUs">
        ...
        <div class="row OneForm anl">

            <div class="contactCol">

                <h3>#What is Android?</h3>

                <p class="ap">Android is a mobile operating system based on a modified version of the Linux kernel and other open source software, designed primarily for touchscreen mobile devices such as smartphones and tablets.
                </p>
                <hr>


                <h3>#Top 8 Reasons to Learn Android Development</h3>

                <ol>
                    <li>It is an Open Source Technology</li>
                    <li>Huge Device Market Share</li>
                    <li>Easier Entry to Market</li>
                    <li>Enormous Market Share of Apps</li>
                    <li>Numerous & Variety of Job Opportunities to Choose from</li>
                    <li>Freedom</li>
                    <li>Easy to Learn</li>
                    <li>Numerous Online Courses</li>
                </ol>
            ...
            <div class="contactCol directMail bdR">
                ...
                <p> If you are a beginner and don’t know where to start, then these courses will help you gain all the knowledge to become a full-fledged Android Developer </p> <br>

                <a href="https://www.youtube.com/watch?v=ZYvbmVEwX14&list=PLgH5QX0i9K3p9xzYLFGdfYliIRBLVDRV5" target="blank" class="heroBtn"> Start Learning <i class="fas fa-external-link-alt"></i></a>
