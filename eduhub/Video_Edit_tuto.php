...
<head>
    ...
    <title>Video Editing Tutorials EDUHub44</title>
...
<body>
    ...
    <section class="sub-header veHeader">
...
<div class="container">
    <div class="rows">
        <div class="rcard col-3 proT">
            ...
            <h2 class="ppr">Adobe Premiere Pro</h2>
            <div class="rtxt">
                <p>Adobe Premiere Pro is a timeline-based video editing software application developed by Adobe Inc. and published as part of the Adobe Creative Cloud licensing program.</p>
            </div>
            <hr><br>
            <a href="https://www.youtube.com/watch?v=h6eeDgBjZq8&list=PLW-zSkCnZ-gABGZU8--ISUauyewG40Yex" target="blank" class="heroBtn"> Start Learning <i class="fas fa-external-link-alt"></i></a>
            <br> <br>
        </div>

        <div class="rcard col-3 proT">

            <h2 class="afe">Adobe After Effects</h2>
            <div class="rtxt">
                <p>Adobe After Effects is a digital visual effects, motion graphics, and compositing application developed by Adobe Systems and used in the post-production process of film making, video games and television production.</p>
            </div>
            <hr><br>
            <a href="https://www.youtube.com/watch?v=Xv8JBXPgeI8&list=PLW-zSkCnZ-gD8OcjTPu-u_Rxl9-kI9Xqr" target="blank" class="heroBtn"> Start Learning
