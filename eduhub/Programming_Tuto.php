...
<head>
    ...
    <title>Programming Tutorials EduHub44</title>
...
<body>
    ...
    <section class="sub-header proTuto">
    ...
    <div class="container">
        <div class="rows">
            ...
            <div class="rcard col-3 proT">
                ...
                <h2 class="cpp">C++ Programming</h2>
                <div class="rtxt">
                    <p>C++ is a powerful general-purpose programming language. It can be used to develop operating systems, browsers, games, and so on. C++ supports different ways of programming like procedural, object-oriented, functional, and so on.</p>
                </div>
                <hr><br>
                <a href="https://www.youtube.com/watch?v=0T4mPpbNs_8&list=PLgH5QX0i9K3q0ZKeXtF--CZ0PdH1sSbYL" target="blank" class="heroBtn"> Start Learning
            ...
            <div class="rcard col-3 proT">
                ...
                <div class="rtxt">
                    <p>Java is a powerful general-purpose programming language. It is used to develop desktop and mobile applications, big data processing, embedded systems, and so on. Java runs on 3 billion devices worldwide.
                    </p>
                </div>
                <hr><br>
                <a href="https://www.youtube.com/watch?v=28P_QSR-ouQ&list=PLgH5QX0i9K3rAHKr6IteF5kdgN6BorH9l" target="blank" class="heroBtn"> Start Learning <i class="fas fa-external-link-alt"></i></a>
                <br> <br>
            ...
            <div class="rcard col-3 proT">
                ...
                <h2 class="python">Python Programming</h2>
                <div class="rtxt">
                    <p>Python is a powerful programming language ideal for scripting and rapid application development. It is used in web development (like: Django and Bottle), scientific and mathematical computing (Orange, SymPy, NumPy) to desktop graphical
                        user Interfaces (Pygame, Panda3D).</p>
                </div>
                <hr><br>
                <a href="https://www.youtube.com/watch?v=xjcCi6Tzfxw&list=PLgH5QX0i9K3rz5XqMsTk41_j15_6682BN" target="blank" class="heroBtn"> Start Learning <i class="fas fa-external-link-alt"></i></a>
                <br> <br>
