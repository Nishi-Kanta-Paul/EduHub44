...
while ($row = mysqli_fetch_array($resultx)) {
        ...
        $x[$i] = new faculty();
        $x[$i]->f_id = $row['f_id'];
        $x[$i]->f_name= $row['f_name'];
        $x[$i]->f_title=$row['f_title'];
        $x[$i]->f_email = $row['f_email'];
        $x[$i]->f_phone = $row['f_phone'];
    $i++;
} 
...
<body>
    ...
    <section class="sub-header proTuto">
        ...
        <h1> Faculty Contact Information </h1>
        <p> Dept. of Computer Science and Engineering (CSE) </p>
    ...
    <section class="container">
        ...
        <?php
                    ...
                    while ($j < $i) {
                        ...
                        echo '<div class="facProfile">
                        <img src="images/Nazrul-Haque.png" alt="">
                        ...
                        <table>
                            <tr>
                                ...
                                <td><a href="#">'.$x[$j]->f_email.'</a></td>
                            </tr>
                            <tr>
                                <td><i class="fa fa-phone"></i></td>
                                <td><a href="tel:+8801715778123">'.$x[$j]->f_phone.'</a></td>
                            </tr>
                        </table>
                    </div>';
